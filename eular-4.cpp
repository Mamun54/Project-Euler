#include<bits/stdc++.h>
using namespace std;
int check(long long int palindrom)
{
    long long temp=palindrom;
...
int main()
{
    ...
    cout<<"the maximun palindrom is"<<max<<endl;
